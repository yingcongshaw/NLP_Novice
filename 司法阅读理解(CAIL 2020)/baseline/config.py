...
def save_settings(args):
    ...
    json.dump(args.__dict__, open(join(args.checkpoint_path, args.name + "_run_settings.json"), 'w'))
...
def set_config():
    ...
    parser.add_argument("--bert_model", type=str, default='bert-base-uncased', help='Currently only support bert-base-uncased and bert-large-uncased')
