...
def read_examples( full_file, full_file_2019):
    '''
    从文件中读取样本案例
    '''
    ...
    if full_file_2019:
           with open(full_file_2019, 'r', encoding='utf-8') as reader:
                full_data_2019 = json.load(reader)  
                full_data.extend(full_data_2019) 
    print("len of full_data:" + str(len(full_data)))
...
if __name__ == '__main__':
    ...
    # 保存样本案例
    examples = read_examples( full_file=args.full_data, full_file_2019 = args.full_data_2019 )
